...
jets_fuehrende_Ordnung_pt_hist = ROOT.TH1D(boson + "_jets_fuehrende_Ordnung_pt",boson + "_jets_fuehrende_Ordnung_pt", 20, 0, 1000)
jets_fuehrende_Ordnung_pt_hist.Sumw2()
jets_fuehrende_Ordnung_eta_hist=ROOT.TH1D(boson + "_jets_fuehrende_Ordnung_eta",boson + "_jets_fuehrende_Ordnung_eta", 50, -10,10) 
...
jets_HT_hist=ROOT.TH1D(boson + "_jets_HT", boson + "_jets_HT", 50, 30, 1000)
jets_HT_hist.Sumw2()
v_boson_jets_fuehrende_Ordnung_DeltaPhi_hist=ROOT.TH1D(boson + "_jets_fuehrende_Ordnung_DeltaPhi", boson + "_jets_fuehrende_Ordnung_DeltaPhi", 50, 0, 3.14)
