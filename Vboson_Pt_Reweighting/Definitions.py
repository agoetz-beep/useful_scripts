...
var_info_dict = {
                         ...
                         "boson_eta" : {"dim" : 1, "hist" : ROOT.TH1D(  "boson_eta",   "boson_eta",20, -10, 10) , "function" : "boson_eta","Xaxis": "Pseudorapiditaet", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Pseudorapiditaet des "+ boson+ " Bosons"},
                         "jets_fuehrende_Ordnung_pt": {"dim" : 1, "hist" : ROOT.TH1D(  "jets_fuehrende_Ordnung_pt",  "jets_fuehrende_Ordnung_pt",len(neue_bin_grenzen) - 1,neue_bins) , "function" : "jet0_pt", "Xaxis": "Transversalimpuls in GeV", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Transversalimpuls des fuehrenden Jets"},
                         "jets_fuehrende_Ordnung_eta": {"dim" : 1, "hist" : ROOT.TH1D(  "jets_fuehrende_Ordnung_eta",  "jets_fuehrende_Ordnung_eta", 20, -8,8) , "function" : "jet0_eta","Xaxis": "Pseudorapiditaet", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Pseudorapiditaet des fuehrenden Jets"},
                         ...
                         "boson jets_fuehrende_Ordnung_DeltaPhi" : {"dim" : 1, "hist" : ROOT.TH1D(  "boson jets_fuehrende_Ordnung_DeltaPhi",   "boson jets_fuehrende_Ordnung_DeltaPhi", 20, 0, 3.14) , "function" : "deltaphi_boson_jet0", "Xaxis": "Betrag des Azimutalwinkels", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Betrag des Azimutalwinkels zwischen "+boson+" Boson und fuehrendem Jet"},
                         ...
                         "geladenes_lepton_eta" : {"dim" : 1, "hist" : ROOT.TH1D(  "geladenes_lepton_eta",   "geladenes_lepton_eta", 20, -10, 10) , "function" : "charged_lepton_eta", "Xaxis": "Pseudorapiditaet", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Pseudorapiditaet des geladenen Leptons"},
                         "boson_invariant_mass" : {"dim" : 1, "hist" : ROOT.TH1D(  "boson_invariant_mass",   "boson_invariant_mass",20, 0, 100) , "function" : "boson_mass", "Xaxis": "Invariante Masse in GeV", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Invariante Masse des geladenen Leptons"},
                         ...
                         "jets_NLO_eta" : {"dim" : 1, "hist" : ROOT.TH1D(  "jets_NLO_eta",  "jets_NLO_eta", 20, -8,8) , "function" : "jet1_eta", "Xaxis": "Pseudorapiditaet", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Pseudorapiditaet des zweiten Jets"},
                         ...
                         "jets_NNLO_eta" : {"dim" : 1, "hist" : ROOT.TH1D(  "jets_NNLO_eta",  "jets_NNLO_eta", 20, -8,8) , "function" : "jet2_eta", "Xaxis": "Pseudorapiditaet", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Pseudorapiditaet des dritten Jets"},
                         ...
                         "jets_NNNLO_eta" : {"dim" : 1, "hist" : ROOT.TH1D(  "jets_NNNLO_eta",  "jets_NNNLO_eta", 20, -8,8) , "function" : "jet3_eta", "Xaxis": "Pseudorapiditaet", "Yaxis": "Wirkungsquerschnitt in pb pro Bin", "Title": "Pseudorapiditaet des vierten Jets"},
